...
class App {
  constructor() {
    ...
    // Framing auto-start state
    this._framingStable = 0;
    this._framingAutoStarted = false;
  ...
  _updateFramingUI(lms) {
    ...
    const bar      = document.getElementById('frame-progress');
    const STABLE   = 60; // 2 seconds at ~30fps
